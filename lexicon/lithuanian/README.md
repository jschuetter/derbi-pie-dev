...
This directory contains an JSONL to CSV parser (`jsonlreader.py`) for the `enwiktionary` data dump from Wiktionary, intended for parsing the Lithuanian lexicon section. See "Input Data Information" below for details on the input data. The output is stored in this directory as `lithuanian.csv`.
