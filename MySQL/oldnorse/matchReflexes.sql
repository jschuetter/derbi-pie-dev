...
SELECT 'ON', lex_ref_link_id, reflex, reflex_normalized, lemma_id, lemma, lemma_normalized
FROM lex_ref_link 
...
SELECT *
FROM reflex_matches
INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/exports/oldnorse_matches.csv'
